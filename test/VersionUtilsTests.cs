...
namespace JiuLing.CommonLibs.Tests
{
    ...
    public class VersionUtilsTests
    {
        ...
        public void CheckNeedUpdateTest(string currentVersion, string newVersion, bool isNeedUpdate)
        {
        ...
        public void CheckNeedUpdate2Test(string currentVersion, string newVersion, string minVersion, bool isNeedUpdate, bool isAllowUse)
        {
